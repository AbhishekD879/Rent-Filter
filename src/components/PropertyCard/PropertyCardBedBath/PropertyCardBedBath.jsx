...
const PropertyCardBedBath = ({bedCount,bathCount}) => {
  return (
    <div className="flex p-4 border-t border-gray-300 text-gray-700">
                        <div className="flex-1 inline-flex items-center">
                            ...
                            <p><span className="text-gray-900 font-bold block">{bedCount}</span> Bedrooms</p>
                        </div>
                        <div className="flex-1 inline-flex items-center">
                            <svg className="h-6 w-6 text-gray-600 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <p><span className="text-gray-900 font-bold">{bathCount}</span> Bathrooms</p>
                        </div>
    </div>
  )
}

export default PropertyCardBedBath